...
\begin{document}
    ...
    \paragraph{Auswertung der Messungen}
        ...
        Die einzelnen Werte lassen sich abermals mit dem gewichteten Mittelwert zusammenfassen und mit dem zugehörigen Fehler angeben als 
        \begin{align}
            \frac{q}{m_e} = 1.81(14) \cdot 10^{11} \frac{\si{\coulomb}}{\si{\kilogram}}
        \end{align}
