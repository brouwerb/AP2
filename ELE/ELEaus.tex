...
\begin{document}
    ...
    \paragraph{Auswertung der Messungen}
        ...
        Daraus lässt sich unter berücksichtigung der Fehlerfortpflanzung \cite{ABW} der gewichtete Mittelwert\cite{ABW} der spzifischen Elementarladung mit entsprechendem Fehler für jeden Radius einzelnd berechen.
    ...
    \begin{table}
        \begin{tabular}{c | c | c}
            ...
            Zeit $t$ in $\si{\second}$ & 1 Digit = 0s1s + Reaktionszeit 0,2s & $u_t = \sqrt(\frac{0.1}{2\sqrt(3)}^2 + 0.4) \si{\second}$ \\
        \end{tabular}
    \end{table}
