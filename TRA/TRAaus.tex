...
\begin{align}
    ...
    \end{pmatrix} \,.
\end{align}
Wih the formulas on the worksheet \cite[(27), (28)]{TRA}, the small signal amplification
\begin{align}
    t
\end{align}
...
\end{align}
This is a high pass filter, because if $\omega$ gets bigger, the denominator gets smaller and $H$ gets bigger. So high frequencies get attenuated less than low frequencies
