...
The operating temperature $T$ = 272,2 \si{\kelvin} can be obtained by using the fitparameters from the exponetial fit and equation \ref{eq:Ib_T}. Althoug the operating temperature has the correct magnitude it schould be at least 30 \si{\kelvin} higher.
